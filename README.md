...
| 平台 | 架构 | tarball 命名 |
|---|---|---|
| macOS (Apple Silicon) | arm64 | `moon-VERSION-macos-arm64.tar.gz` |
| Linux | x86_64 | `moon-VERSION-linux-x86_64.tar.gz` |

> 暂不支持 macOS x86_64 / Linux arm64 / Windows。
...
- Erlang/OTP 28（release self-contained，无需用户预装）
- 暂不支持 Windows / macOS x86_64 / Linux arm64
